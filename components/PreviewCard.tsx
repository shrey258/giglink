...
const widgetData = [
  {
    ...
    content: (
      <div className="flex items-center gap-3 w-500">
        <motion.div
...
export default function PreviewCard({ className }: PreviewCardProps) {
  ...
  return (
    ...
    >
      {/* Audi-style progress indicators: colors from past widgets */}
      ...
      <motion.div
        ...
        exit={{ scale: 0, opacity: 0, transform: 'translateY(-100%)' }}
        transition={{ duration: 0.3}}
        className="flex items-center gap-3 w-full max-w-[240px]"
      >
